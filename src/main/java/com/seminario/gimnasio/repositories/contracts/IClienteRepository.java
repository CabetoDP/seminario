...
public interface IClienteRepository extends JpaRepository<Cliente, Long>{
    ...
    @Query(value = "SELECT altura, peso FROM Usuarios INNER JOIN Clientes ON Usuarios.id = Clientes.id_usuario_id WHERE Usuarios.correo = :correo AND Usuarios.contraseña = :contraseña", nativeQuery = true)
